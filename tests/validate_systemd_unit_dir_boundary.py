...
required_repair = (
    ...
    '[ "$unit_mode" = "644" ]',
    '[ "$unit_sha" = "$EXPECTED_TUNNEL_UNIT_SHA" ]',
    'secure_active=$(systemctl is-active edge1-secure-mcp-tunnel.service',
    'secure_enabled=$(systemctl is-enabled edge1-secure-mcp-tunnel.service',
    'operator_active=$(systemctl is-active edge1-operator-mcp.service',
    'operator_enabled=$(systemctl is-enabled edge1-operator-mcp.service',
    'bigbird_active=$(systemctl is-active bigbird-ai-tunnel.service',
    'bigbird_enabled=$(systemctl is-enabled bigbird-ai-tunnel.service',
    '[ "$secure_active" = "inactive" ]',
    '[ "$secure_enabled" = "disabled" ]',
    '[ "$operator_active" = "active" ]',
    '[ "$operator_enabled" = "enabled" ]',
    '[ "$bigbird_active" = "active" ]',
    '[ "$bigbird_enabled" = "enabled" ]',
