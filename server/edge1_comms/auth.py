"""Credential hashing helpers for Edge1 Comms Relay."""
...
def hash_password(password: str, *, iterations: int = 240_000, salt: bytes | None = None) -> tuple[str, str]:
    if not password:
...
def verify_password(password: str, salt_b64: str, digest_b64: str, *, iterations: int = 240_000) -> bool:
    try:
