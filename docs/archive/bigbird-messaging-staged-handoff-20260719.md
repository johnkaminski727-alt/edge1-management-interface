...
- No live registry, service, public port, customer traffic, or carrier routing changes were made.
...
3. Create a dedicated read-only service secret outside source control.
...
This archive does not authorize messaging pause or resume controls, customer or carrier traffic changes, firewall or public exposure changes, secret disclosure, emergency-calling changes, or destruction of rollback material.
