...
Private evidence stays in its authoritative restricted system. The repository record contains only a sanitized evidence identifier, source class, review timestamp, retention class, and a short non-identifying summary.
