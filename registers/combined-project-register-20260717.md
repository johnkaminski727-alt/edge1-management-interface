...
- No live registry, service reload, public listening port, customer traffic, or carrier routing changes were made.
...
- Create and install a dedicated read-only service secret outside Git.
