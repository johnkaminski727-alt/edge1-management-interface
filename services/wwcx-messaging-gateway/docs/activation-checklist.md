...
- [x] **Live private Edge1 acceptance:** done for the Phase 3 carrier-neutral foundation as of PR #440 (2026-08-19) — see docs/phase3-readiness-state.md. This acceptance predates the Telnyx (2026-08-20) and Bandwidth (2026-08-20, PR #486) adapters added afterward and does not cover them; carrier-live acceptance for either adapter remains a separate, still-open gate.
- [x] **Carrier selection and adapter:** engineering-level adapter implementation and unit-level signature/replay/payload/send/delivery-status testing done for both Telnyx and Bandwidth (unregistered, simulator-only registry — see docs/carrier-adapter-decision-20260820.md). Live testing against real provider credentials remains blocked on the carrier/production authorization gates below, not on missing engineering work.
