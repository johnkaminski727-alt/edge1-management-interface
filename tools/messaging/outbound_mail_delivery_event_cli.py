...
The CLI is offline. It does not expose a listener, contact a provider, inspect provider credentials, read message content, or send mail. Synthetic events require an explicit test-only flag and must never be used with a production database.
"""
