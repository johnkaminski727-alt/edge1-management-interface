...
verified STARTTLS, authenticates, executes NOOP and RSET, then quits. It never issues envelope, recipient, content, or submission commands and never sends a message. Credentials are never printed or accepted as command-line values.
"""
...
def run_canary(
    ...
    *,
    ...
    try:
        ...
        _smtp_code(client.starttls(context=ssl_context_factory()), "STARTTLS")
    ...
    return {
        ...
        "checked_at": checked_at.astimezone(timezone.utc).isoformat(timespec="seconds"),
